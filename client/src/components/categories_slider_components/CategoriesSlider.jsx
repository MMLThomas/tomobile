...
const CategoriesSlider = () => {
    ...
    const categories = [
        {name: categoriesSliderText[language]['Sport'], image: 'https://www.fairwayford.com/inventoryphotos/4227/1fa6p8cf9l5132739/ip/7.jpg?height=400'}, 
        {name: categoriesSliderText[language]['Exotic'], image: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/2020-lamborghini-huracan-evo-spyder-drive-111-1564544744.jpg?crop=1xw:1xh;center,top&resize=480:*'}, 
        {name: categoriesSliderText[language]['Car'], image: 'https://stimg.cardekho.com/images/carexteriorimages/630x420/Maruti/Swift/7083/1587199027573/front-left-side-47.jpg'}, 
